...
#### Stream 的分组
1. 分组对应的Sql语句中的GroupBy 
2. 分组操作如果使用传统的编程方式， 非常复杂。 但是同过流的的分组方式让代码变得非常简单。
 

### 作业
1. 对"hello world" ,"wolrd hello","hello welcome","welcome world" 这些词组的中的单词进行去重并输出，最后的输出结果为"hello,world,welcome"(不用关单词输出的顺序)提示：使用flatmap
